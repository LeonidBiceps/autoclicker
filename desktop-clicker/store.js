...
const DEFAULT_SETTINGS = {
  ...
  clashTracker: {
    ...
    // распознаёт разыгранные карты по картинке в заданной области экрана.
    enabled: false,
    region: null, // { x, y, width, height } — где на экране появляется разыгранная противником карта
    confidence: 0.85,
    pollIntervalMs: 700, // как часто сравнивать область экрана со всей базой карт
    cooldownMs: 1200, // не засчитывать ту же карту снова раньше чем через столько мс (защита от "залипания" на экране)
