...
const CLASH_CARDS = [
  ...
  { id: "tombstone", name: "Надгробие", elixir: 3 },
  ...
  { id: "furnace", name: "Горн", elixir: 4 },
  { id: "goblin-hut", name: "Хижина гоблинов", elixir: 5 },
  ...
  { id: "minion-horde", name: "Орда миньонов", elixir: 5 },
  { id: "wizard", name: "Волшебник", elixir: 5 },
  { id: "royal-recruits", name: "Королевские рекруты", elixir: 7 },
  { id: "skeleton-army", name: "Армия скелетов", elixir: 3 },
  { id: "baby-dragon", name: "Дракончик", elixir: 4 },
  { id: "prince", name: "Принц", elixir: 5 },
  { id: "witch", name: "Ведьма", elixir: 5 },
  ...
  { id: "barbarian-hut", name: "Хижина варваров", elixir: 6 },
  { id: "elite-barbarians", name: "Элитные варвары", elixir: 6 },
  { id: "fireball", name: "Огненный шар", elixir: 4 },
  { id: "goblin-gang", name: "Банда гоблинов", elixir: 3 },
  { id: "guards", name: "Стражи", elixir: 3 },
  { id: "lumberjack", name: "Лесоруб", elixir: 4 },
  { id: "night-witch", name: "Ночная ведьма", elixir: 4 },
  { id: "poison", name: "Яд", elixir: 4 },
  { id: "rocket", name: "Ракета", elixir: 6 },
  { id: "tesla", name: "Тесла", elixir: 4 },
  { id: "three-musketeers", name: "Три мушкетёра", elixir: 9 },
  ...
  { id: "goblin-drill", name: "Бур гоблинов", elixir: 4 },
  { id: "graveyard", name: "Кладбище", elixir: 5 },
  ...
  { id: "skeleton-king", name: "Король скелетов", elixir: 4 },
